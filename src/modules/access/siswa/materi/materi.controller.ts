...
/**
 * Thin HTTP adapter for Siswa's material operations.
 * GET: Available to all authenticated users (siswa + tutor).
 * CREATE/UPDATE/DELETE: Authorization handled by business logic (tutor_id check).
 */
