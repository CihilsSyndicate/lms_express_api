...
export const createStudentAnswerLogSchema = studentAnswerLogBaseSchema.omit({
  id: true,
  answered_at: true,
});
export const updateStudentAnswerLogSchema = studentAnswerLogBaseSchema
  .partial()
  .omit({ id: true, siswa_id: true, modul_id: true, question_id: true });

export type StudentAnswerLog = z.infer<typeof studentAnswerLogBaseSchema>;
export type CreateStudentAnswerLogRecord = z.infer<
  typeof createStudentAnswerLogSchema
>;
export type UpdateStudentAnswerLogRecord = z.infer<
  typeof updateStudentAnswerLogSchema
>;
