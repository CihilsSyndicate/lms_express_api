...
-- AddForeignKey
ALTER TABLE "ComputationalThinking" ADD CONSTRAINT "ComputationalThinking_modul_id_fkey" FOREIGN KEY ("modul_id") REFERENCES "Modul"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Signature" ADD CONSTRAINT "Signature_tutor_id_fkey" FOREIGN KEY ("tutor_id") REFERENCES "Tutor"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
