...
export const createSoalPosttestSchema = soalPosttestBaseSchema.omit({
  id: true,
});
export const updateSoalPosttestSchema = soalPosttestBaseSchema
  .partial()
  .omit({ id: true, posttest_id: true });

export type SoalPosttest = z.infer<typeof soalPosttestBaseSchema>;
export type CreateSoalPosttestRecord = z.infer<
  typeof createSoalPosttestSchema
>;
export type UpdateSoalPosttestRecord = z.infer<
  typeof updateSoalPosttestSchema
>;
